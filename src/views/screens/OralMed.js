...
export default function OralMed({navigation}){
    ...
    return(
        <SafeAreaView style={styles.container}>
            <Text style={styles.text}>Oral Medication</Text>
            ...
            <TouchableOpacity style={styles.addButton} onPress={()=>{navigation.navigate("AddOralMedicine");}}>
