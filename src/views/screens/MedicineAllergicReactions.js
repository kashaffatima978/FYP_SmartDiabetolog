...
export default function MedicineAllergicReactions({navigation}){
    ...
    return(
        <SafeAreaView style={styles.container}>
            <Text style={styles.text}>Medication Allergic Reaction</Text>
            ...
            <TouchableOpacity style={styles.addButton} onPress={()=>{navigation.navigate("AddMedicineAllergicReactions");}}>
