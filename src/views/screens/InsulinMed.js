...
export default function InsulinMed({navigation}){
    ...
    return(
        <SafeAreaView style={styles.container}>
            <Text style={styles.text}>Insulin Medication</Text>
            ...
            <TouchableOpacity style={styles.addButton} onPress={()=>{navigation.navigate("AddInsulinMedicine");}}>
